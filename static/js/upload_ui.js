...
var up = document.getElementById('file-input');
var fname = document.getElementById('my_filename');
...
up.addEventListener("change", function () { 
	console.log("Oh");
	fname.innerHTML = up.files[0].name;
    ...
    return __generator(this, function (_a) {
        ...
        switch (_a.label) {
            ...
            case 3:
                _a.sent();
                upload.className = "upload uploading uploaded";
                return [2 /*return*/];
        }
    });
}); });